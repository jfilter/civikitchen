...
final class Api4Catalog
{
    ...
    public const ENTITIES = [
        ...
        'CaseType' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'definition description id is_active is_reserved name title weight', 'c' => true],
        'Contact' => ['a' => 'autocomplete checkAccess create delete get getActions getChecksum getDuplicates getFields getLinks getMergedFrom getMergedTo mergeDuplicates replace save update validateChecksum', 'f' => 'addressee_custom addressee_display addressee_id age_years api_key birth_date communication_style_id contact_sub_type contact_type created_date deceased_date display_name do_not_email do_not_mail do_not_phone do_not_sms do_not_trade email_greeting_custom email_greeting_display email_greeting_id employer_id external_identifier first_name formal_title gender_id groups hash household_name id image_URL is_deceased is_deleted is_opt_out job_title last_name legal_identifier legal_name middle_name modified_date next_birthday nick_name organization_name postal_greeting_custom postal_greeting_display postal_greeting_id preferred_communication_method preferred_language preferred_mail_format prefix_id primary_contact_id sic_code sort_name source suffix_id user_unique_id', 'c' => true],
        'ContactType' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'description icon id image_URL is_active is_reserved label name parent_id', 'c' => true],
        ...
        'CustomField' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'attributes column_name custom_group_id data_type date_format default_value end_date_years file_is_public filter fk_entity fk_entity_on_delete help_post help_pre html_type id in_selector is_active is_required is_search_range is_searchable is_view label name note_columns note_rows option_group_id option_values options_per_line serialize start_date_years text_length time_format weight', 'c' => true],
        'CustomGroup' => ['a' => 'autocomplete checkAccess create delete get getActions getAfforms getFields getLinks getSearchKit replace save update', 'f' => 'collapse_adv_display collapse_display created_date created_id extends extends_entity_column_id extends_entity_column_value help_post help_pre icon id is_active is_multiple is_public is_reserved max_multiple min_multiple name style table_name title weight', 'c' => true],
        'CustomValue' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'entity_id id', 'c' => false],
        'Dashboard' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'cache_minutes directive domain_id fullscreen_url id is_active is_reserved label name permission permission_operator url', 'c' => true],
        ...
        'DedupeRule' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'dedupe_rule_group_id id rule_field rule_length rule_table rule_weight', 'c' => true],
        'DedupeRuleGroup' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'contact_type id is_reserved name threshold title used', 'c' => true],
        ...
        'Household' => ['a' => 'autocomplete checkAccess create delete get getActions getChecksum getDuplicates getFields getLinks getMergedFrom getMergedTo mergeDuplicates replace save update validateChecksum', 'f' => 'addressee_custom addressee_display addressee_id api_key birth_date communication_style_id contact_sub_type contact_type created_date deceased_date display_name do_not_email do_not_mail do_not_phone do_not_sms do_not_trade email_greeting_custom email_greeting_display email_greeting_id employer_id external_identifier first_name formal_title gender_id hash household_name id image_URL is_deceased is_deleted is_opt_out job_title last_name legal_identifier legal_name middle_name modified_date nick_name organization_name postal_greeting_custom postal_greeting_display postal_greeting_id preferred_communication_method preferred_language preferred_mail_format prefix_id primary_contact_id sic_code sort_name source suffix_id user_unique_id', 'c' => true],
        ...
        'Job' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'api_action api_entity description domain_id id is_active last_run last_run_end name parameters run_frequency scheduled_run_date', 'c' => true],
        ...
        'Navigation' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'domain_id has_separator icon id is_active label name parent_id permission permission_operator url weight', 'c' => true],
        ...
        'OAuthClient' => ['a' => 'authorizationCode autocomplete checkAccess clientCredential create delete get getActions getFields getLinks replace save update userPassword', 'f' => 'created_date guid id is_active modified_date options provider secret tenant', 'c' => true],
        ...
        'OptionGroup' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'data_type description id is_active is_locked is_reserved name option_value_fields title', 'c' => true],
        'OptionValue' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'color component_id description domain_id filter grouping icon id is_active is_default is_optgroup is_reserved label name option_group_id value visibility_id weight', 'c' => true],
        ...
        'ParticipantStatusType' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'class id is_active is_counted is_reserved label name visibility_id weight', 'c' => true],
        ...
        'PaymentProcessorType' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'billing_mode class_name description id is_active is_default is_recur name password_label payment_instrument_id payment_type signature_label subject_label title url_api_default url_api_test_default url_button_default url_button_test_default url_recur_default url_recur_test_default url_site_default url_site_test_default user_name_label', 'c' => true],
        ...
        'Queue' => ['a' => 'autocomplete checkAccess claimItems create delete get getActions getFields getLinks replace reset run runItems save update', 'f' => 'batch_limit error id is_template lease_time name retry_interval retry_limit runner status type', 'c' => true],
        'QueueItem' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'data id queue_name release_time run_count submit_time weight', 'c' => true],
        ...
        'RelationshipType' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'contact_sub_type_a contact_sub_type_b contact_type_a contact_type_b description id is_active is_reserved label_a_b label_b_a name_a_b name_b_a', 'c' => true],
        'Report' => ['a' => 'checkAccess get getActions getFields getLinks', 'f' => '', 'c' => false],
        'ReportInstance' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'args created_id description domain_id drilldown_id email_cc email_subject email_to footer form_values grouprole header id is_active is_reserved name navigation_id owner_id permission report_id title', 'c' => true],
        'RiverleaStream' => ['a' => 'activate autocomplete checkAccess create delete get getActions getFields getLinks getWithFileContent render replace save update', 'f' => 'css_file css_file_dark custom_css custom_css_dark description extension file_prefix id is_reserved label modified_date name vars vars_dark', 'c' => true],
        'Role' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'id is_active label name permissions', 'c' => true],
        ...
        'SavedSearch' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'api_entity api_params created_date created_id description expires_date form_values id is_current is_template label mapping_id modified_date modified_id name search_custom_id', 'c' => true],
        'SearchDisplay' => ['a' => 'autocomplete checkAccess create createBatch delete download emailReport get getActions getDefault getFields getLinks getMarkup getSearchTasks importBatch inlineEdit replace run runBatch save saveFile update', 'f' => 'acl_bypass id is_autocomplete_default label name saved_search_id settings type', 'c' => true],
        ...
        'SearchSegment' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'description entity_name id items label name', 'c' => true],
        ...
        'SiteToken' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'body_html body_text created_id domain_id id is_active is_reserved label modified_date modified_id name', 'c' => true],
        ...
        'Survey' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'activity_type_id bypass_confirm campaign_id created_date created_id default_number_of_contacts id instructions is_active is_default is_share last_modified_date last_modified_id max_number_of_contacts release_frequency result_id thankyou_text thankyou_title title', 'c' => true],
        'System' => ['a' => 'check checkAccess flush getActions getFields getLinks rotateKey', 'f' => '', 'c' => false],
        'Tag' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'color created_date created_id description id is_reserved is_selectable is_tagset label name parent_id used_for', 'c' => true],
        ...
        'UFField' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'field_name field_type help_post help_pre id in_selector is_active is_multi_summary is_required is_reserved is_searchable is_view label location_type_id phone_type_id uf_group_id visibility website_type_id weight', 'c' => true],
        'UFGroup' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'add_cancel_button add_captcha add_to_group_id cancel_button_text cancel_url created_date created_id description frontend_title group_type help_post help_pre id is_active is_cms_user is_edit_link is_map is_proximity_search is_reserved is_uf_link is_update_dupe limit_listings_group_id name notify post_url submit_button_text title', 'c' => true],
        ...
        'UserJob' => ['a' => 'autocomplete checkAccess create delete get getActions getFields getLinks replace save update', 'f' => 'created_date created_id end_date expires_date id is_current is_template job_type label metadata name queue_id search_display_id start_date status_id', 'c' => true],
    ...
    public const ANY_ENTITY_FIELDS = [
        'base_module', 'has_base', 'local_modified_date',
    ];
